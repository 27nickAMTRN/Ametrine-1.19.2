...
public class AmetrineClusterBlock extends AmethystBlock implements Waterloggable {
    ...
    public AmetrineClusterBlock(int height, int xzOffset, AbstractBlock.Settings settings) {
        super(settings);
